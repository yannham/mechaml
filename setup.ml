...
(* OASIS_START *)
(* DO NOT EDIT (digest: fdf4e3bb3e593e8462baf4cade117138) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "login.ml"});
               Executable
                 ({
                     cs_name = "unit_tests";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest = Some "\206\130\127\136\198RB\012\\\186\148\140W\183[\167";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
