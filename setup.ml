...
(* OASIS_START *)
(* DO NOT EDIT (digest: 28dabad9b37843061fb0a506a0e3be6d) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Agent"; "Page"; "Cookiejar"; "Formatting"];
                      lib_pack = true;
                      lib_internal_modules = ["Option"];
     ...
     oasis_digest = Some "\244\1808\189\248Z\175)L\174\217\172Jp\192|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
