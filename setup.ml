...
(* OASIS_START *)
(* DO NOT EDIT (digest: f9c017e2f0b16d22362430ba16703c6d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/yannham/mechaml";
          bugreports = None;
          synopsis =
            "A web browsing library built on top of Lambdasoup and Cohttp. Inspired by WWW::Mechanize";
          description =
            Some
              [
                 OASISText.Para
                   "Mechaml provides an HTTP agent to interact with websites through an OCaml program. It uses cohttp to parse and build HTTP requests/responses, and Lambdasoup to parse HTML pages. Mechaml automatically manages cookies, HTTP headers, allows to follow links and to analyze and submit forms."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Compile examples";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Agent"; "Page"; "Cookiejar"];
                      lib_pack = true;
                      lib_internal_modules = ["Infix"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mechaml";
                           FindlibPackage ("uri", None);
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt_ssl", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "github_form.ml"});
               Executable
                 ({
                     cs_name = "example_download_images";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "download_images.ml"});
               Executable
                 ({
                     cs_name = "example_login";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "reddit_login.ml"});
               Executable
                 ({
                     cs_name = "unit_tests";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/yannham/mechaml.git/";
                      src_repo_browser =
                        Some "https://github.com/yannham/mechaml";
     ...
     oasis_digest =
       Some "\232\021\169\218]\171\167\243\185\196\203\130\021F\208\187";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
